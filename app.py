...
from spiral_dashboard_pro import render_spiral_dashboard
...
def main() -> None:
    ...
    st.set_page_config(
        page_title="Mineral Processing Plant Dashboards",
        layout="wide",
    )

    module_name = st.radio(
        "Select Plant Module",
        ["Spiral Module", "Cleaner Module"],
        horizontal=True,
    )

    if module_name == "Spiral Module":
